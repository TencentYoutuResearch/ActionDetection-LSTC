...
# -----------------------------------------------------------------------------
# Config definition the base DATA_DIR should be set here
# -----------------------------------------------------------------------------
_C = CfgNode()
_C.HOME_DIR = os.getenv('HOME')
_C.DATA_DIR = osp.join(_C.HOME_DIR, 'data', 'AVA')
...
# If True, print out the loading detail information with caffe2 backend
_C.TRAIN.CHECKPOINT_VERBOSE = False
...
# If True, print out the loading detail information with caffe2 backend
_C.TEST.CHECKPOINT_VERBOSE = False

# If True, the test is performed offline
_C.TEST.OFFLINE = False
...
# output dimension
_C.SLOWFAST.OUTPUT_CHANNEL = [1024, 256]

# ---------------------------------------------------------------------------- #
# LSTC options
# ---------------------------------------------------------------------------- #
_C.LSTC = CfgNode()
# enable feature LSTC and memory reader
_C.LSTC.ENABLE = False

# context config
_C.LSTC.SHORT_CONTEXT_KEY = [256, 64]

_C.LSTC.SHORT_CONTEXT_VAL = [512, 128]

_C.LSTC.NUM_READERS = 2
...
_C.DATA.PATH_TO_DATA_DIR = _C.DATA_DIR
...
_C.AVA.FRAME_DIR = osp.join(_C.DATA_DIR, 'frames') # "/mnt/fair-flash3-east/ava_trainval_frames.img/"

# Directory path for files of frame lists.
_C.AVA.FRAME_LIST_DIR = osp.join(_C.DATA_DIR, 'lists')

# Directory path for annotation files.
_C.AVA.ANNOTATION_DIR = osp.join(_C.DATA_DIR, 'annotations')

# Path for AVA Feature bank
_C.AVA.FEATURE_BANK_PATH = ''
_C.AVA.SLIDING_WINDOW_SIZE = 4
_C.AVA.GATHER_BANK = True
_C.AVA.FEATURE_BANK_DIM = 1280
_C.AVA.TEMPORAL_EMBED = 0

# Filenames of training samples list files.
_C.AVA.TRAIN_LISTS = ["train.txt"]

# Filenames of test samples list files.
_C.AVA.TEST_LISTS = ["val.txt"]

# Set feature extraction mode
_C.AVA.FEATURE_EXTRACTION = False
